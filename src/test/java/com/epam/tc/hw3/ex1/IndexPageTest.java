...
public class IndexPageTest extends BaseTest {
    ...
    public void testIndexPageElements() {
        ...
        softAssert.assertEquals(indexPage.getUserName(), PropertiesReader.readProperty("user.profile.name"));
        // 5. Assert that there are 4 items on the header section are displayed, and they have proper texts
        List<String> indexPageHeaderMenusNames = indexPage.getHeader().getHeaderMenusNames();
